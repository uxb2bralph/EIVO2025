...
namespace ModelCore.Security
{
    public static class AuthorityExtensions
    {
        ...
        public static OrganizationToken CheckAuthToken(this GenericDbContext<ApplicationDbContext> models, Organization seller, AuthTokenViewModel viewModel)
        {
        ...
        public static UserProfile PrepareTwoFactorKey(this UserProfile item, GenericDbContext<ApplicationDbContext> models)
        {
