...
namespace ModelCore.InvoiceManagement.zhTW
{
    public static partial class CancelAllowanceRootValidator
    {
        ...
        public static Exception CheckMandatoryFields_Proxy(this CancelAllowanceRootCancelAllowance item, GenericDbContext<ApplicationDbContext> mgr, OrganizationToken owner, out InvoiceAllowance allowance, out DateTime cancelDate)
        {
