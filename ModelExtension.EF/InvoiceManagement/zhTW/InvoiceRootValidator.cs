...
namespace ModelCore.InvoiceManagement.zhTW
{
    public static partial class InvoiceRootValidator
    {
        ...
        public static Exception CheckInvoice(this InvoiceRootInvoice invItem, GenericDbContext<ApplicationDbContext> mgr, out String trackCode, out String invNo, out DateTime invoiceDate)
        {
            trackCode = null;
            invNo = null;
        ...
        public static Exception CheckDataNumber(this InvoiceRootInvoice invItem, Organization seller, GenericDbContext<ApplicationDbContext> mgr, out InvoicePurchaseOrder order)
        {
            order = null;
        ...
        public static Exception CheckBusiness(this InvoiceRootInvoice invItem, GenericDbContext<ApplicationDbContext> mgr, OrganizationToken owner, out Organization seller)
        {
        ...
        public static Exception CheckAppliedInvoiceNo(this InvoiceRootInvoice invItem, GenericDbContext<ApplicationDbContext> mgr, Organization seller,DateTime invoiceDate,String trackCode,String invoiceNo)
        {
        ...
        public static Exception CheckBusiness_Proxy(this InvoiceRootInvoice invItem, GenericDbContext<ApplicationDbContext> mgr, OrganizationToken owner, out Organization seller)
        {
            seller = mgr.GetTable<Organization>().Where(o => o.ReceiptNo == invItem.SellerId).FirstOrDefault();
        ...
        public static Exception CheckInvoiceProductItems(this InvoiceRootInvoice invItem, out IEnumerable<InvoiceProductItem> productItems)
        {
            ...
            foreach (var product in productItems)
            {
                ...
                {
                    return new Exception(String.Format("品項名稱不可空白長度不得大於256，傳送資料：{0}，TAG:< Description />", product.Product.Brief));
                }
