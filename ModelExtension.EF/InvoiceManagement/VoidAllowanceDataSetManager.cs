...
namespace ModelCore.InvoiceManagement
{
    public class VoidAllowanceDataSetManager : InvoiceManagerV3
    {
        ...
        public VoidAllowanceDataSetManager(GenericDbContext<ApplicationDbContext> mgr) : base(mgr) { }
        ...
        {
            InvoiceAllowance allowance = target.Allowance;
            DataRow row = result.NewRow();
            ...
            row[(int)ResultField.InvoiceNo] = String.Join(",", allowance.InvoiceAllowanceDetails.Select(d => d.InvoiceNo));
