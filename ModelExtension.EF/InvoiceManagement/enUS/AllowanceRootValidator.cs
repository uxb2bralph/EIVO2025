...
namespace ModelCore.InvoiceManagement.enUS
{
    public static partial class AllowanceRootValidator
    {
        ...
        public static Exception CheckAllowanceItem(this AllowanceRootAllowance item, GenericDbContext<ApplicationDbContext> mgr, out List<InvoiceAllowanceItem> productItems)
        {
