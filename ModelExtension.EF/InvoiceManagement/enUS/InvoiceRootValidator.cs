...
namespace ModelCore.InvoiceManagement.enUS
{
    public static partial class InvoiceRootValidator
    {
        ...
        //    if (!ModelCore.InvoiceManagement.zhTW.InvoiceRootValidator.__InvoiceTypeList.Contains(invItem.InvoiceType))
        //    {
        ...
        //public static Exception CheckInvoiceCarrier(this InvoiceRootInvoice invItem, Company seller, out bool printed, out InvoiceCarrier carrier)
        //{
        //    carrier = null;
        ...
        public static Exception CheckInvoiceProductItems(this InvoiceRootInvoice invItem, out IEnumerable<InvoiceProductItem> productItems)
        {
            ...
            foreach (var product in productItems)
            {
                ...
                {
                    return new Exception(String.Format("Maximum length of Description should not exceed 256 digitals, Incorrect Description: {0}，Incorrect TAG:< Description />", product.Product.Brief));
                }
