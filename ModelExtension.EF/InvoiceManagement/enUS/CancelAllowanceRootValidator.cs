...
namespace ModelCore.InvoiceManagement.enUS
{
    public static partial class CancelAllowanceRootValidator
    {
        ...
        public static Exception CheckMandatoryFields(this CancelAllowanceRootCancelAllowance item, GenericDbContext<ApplicationDbContext> mgr, OrganizationToken owner, out InvoiceAllowance allowance, out DateTime cancelDate)
        {
        ...
        public static Exception VoidAllowance(this DataRow item, GenericDbContext<ApplicationDbContext> models, Organization owner,ref InvoiceAllowanceCancellation voidItem,ref DerivedDocument p,ref Organization expectedSeller)
        {
