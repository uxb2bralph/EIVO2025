...
namespace ModelCore.InvoiceManagement.Validator
{
    public partial class TrackNoIntervalValidator
    {
        ...
        protected GenericDbContext<ApplicationDbContext> _mgr;
        ...
        public TrackNoIntervalValidator(GenericDbContext<ApplicationDbContext> mgr, OrganizationToken owner)
        {
            _mgr = mgr;
            _owner = owner;
        }
        ...
        protected virtual Exception checkBusiness()
        {
            ...
            if (_seller.CompanyID != _owner.CompanyID && !_mgr.GetTable<InvoiceIssuerAgent>().Any(a=>a.AgentID==_owner.CompanyID && a.IssuerID==_seller.CompanyID))
            {
                ...
                return new Exception(String.Format(MessageResources.InvalidSellerOrAgent, _branchMain.SellerId, _owner.Company.ReceiptNo));
            }
        ...
        protected virtual Exception checkInterval()
        {
            ...
            if (_mgr.GetTable<InvoiceNoInterval>().Any(t => t.TrackID == track.TrackID && t.StartNo >= endNo && t.InvoiceNoAssignment.Count > 0
