...
namespace ModelCore.InvoiceManagement.Validator
{
    public partial class GooglePlayAllowanceValidator : AllowanceRootAllowanceValidator
    {
        ...
        public GooglePlayAllowanceValidator(GenericDbContext<ApplicationDbContext> mgr, Organization owner) : base(mgr,owner)
        {
        ...
        protected override Exception CheckAllowanceItem()
        {
            ...
            var productItems = models.GetTable<InvoiceItem>().Where(i => i.InvoiceCancellation == null)
                    ...
                    .Where(b => b.InvoiceBuyer != null && b.InvoiceBuyer.CustomerID == _allowanceItem.GoogleId)
                    .SelectMany(d => d.Product.SelectMany(p => p.InvoiceProductItem));
            ...
            foreach (var i in _allowanceItem.AllowanceItem)
            {
                ...
                {
                    var totalCost = (p.CostAmount ?? 0)
                            - ((p.InvoiceAllowanceItem.Sum(a => a.Amount)) ?? 0);
                ...
                originalInvoice = item!.Invoice.First();
            ...
            _newItem.InvoiceAllowanceDetails.AddRange(_productItems);
