...
namespace ModelCore.InvoiceManagement.Validator
{
    ...
    {
        protected GenericDbContext<ApplicationDbContext> models;
        ...
        public AllowanceRootAllowanceValidator(GenericDbContext<ApplicationDbContext> mgr, Organization? owner)
        {
            models = mgr;
            _owner = owner;
        }
