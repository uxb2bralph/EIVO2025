...
namespace ModelCore.InvoiceManagement.Validator
{
    public partial class InvoiceRootInvoiceValidator
    {
        ...
        protected GenericDbContext<ApplicationDbContext> _models;
        ...
        public InvoiceRootInvoiceValidator(GenericDbContext<ApplicationDbContext> mgr, Organization? owner)
        {
            _models = mgr;
            _owner = owner;
        ...
        public GenericDbContext<ApplicationDbContext> DataSource => _models;
