...
namespace ModelCore.InvoiceManagement
{
    public class AllowanceDataSetManager : InvoiceManagerV3
    {
        ...
        public AllowanceDataSetManager(GenericDbContext<ApplicationDbContext> mgr) : base(mgr) { }
        ...
        protected void ReportSuccess(DataTable result, InvoiceAllowance target)
        {
            ...
            row[(int)ResultField.InvoiceNo] = String.Join(",", target.InvoiceAllowanceDetails.Select(d => d.InvoiceNo));
