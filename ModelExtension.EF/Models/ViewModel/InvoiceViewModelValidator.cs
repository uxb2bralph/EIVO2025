...
namespace ModelCore.Models.ViewModel
{
    public partial class InvoiceViewModelValidator
    {
        ...
        protected virtual Exception checkBusinessDetails()
        {
            ...
            if (_invItem.B2BRelation == true && _seller.BusinessRelationshipMaster.Count > 0)
            {
                ...
                {
                    var buyerItems = _seller.BusinessRelationshipMaster.Select(r => r.Relative);
                    ...
                    buyer = branch != null ? branch.Company : buyerItems.FirstOrDefault();
                }
