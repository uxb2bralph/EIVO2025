...
namespace ModelCore.Models.ViewModel
{
    ...
    {
        public static IQueryable<InvoiceItem> InquireInvoice(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models,ref bool effective, bool queryVoid = true)
        {
            items = items.InquireInvoiceIgnoreDate(viewModel, models, ref effective, queryVoid)
                        .QueryByInvoiceDate(viewModel, models, ref effective);

            return items;
        }

        private static IQueryable<InvoiceItem> InquireInvoiceIgnoreDate(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective, bool queryVoid = true)
        {
            ...
            {
                items = models.GetInvoiceByAgent(items, viewModel.AgentID.Value);
            }
        ...
        public static IQueryable<InvoiceItem> InquireVoidInvoice(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
            items = items.InquireInvoiceIgnoreDate(viewModel, models, ref effective, false);
        ...
        public static IQueryable<InvoiceAllowance> InquireVoidAllowance(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models,ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
            items = items.InquireAllowanceIgnoreDate(viewModel, models, ref effective, false);
        ...
        public static IQueryable<InvoiceItem> QueryByInvoiceNo(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByDataNo(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByProcessType(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByAttachment(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByWelfare(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByBuyerReceiptNo(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByBuyerName(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByCustomerID(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByInvoiceDate(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceItem> QueryByWinning(this IQueryable<InvoiceItem> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceAllowance> QueryEffective(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceAllowance> InquireAllowance(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models,ref bool effective, bool queryVoid = false)
        {
            viewModel ??= new InquireInvoiceViewModel { };
            items = items.InquireAllowanceIgnoreDate(viewModel, models, ref effective, queryVoid)
                        .QueryByAllowanceDate(viewModel, models, ref effective);

            return items;
        }

        private static IQueryable<InvoiceAllowance> InquireAllowanceIgnoreDate(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective, bool queryVoid = false)
        {
            viewModel = viewModel ?? new InquireInvoiceViewModel { };
            items = items.QueryByProcessType(viewModel, models, ref effective)
                        .QueryByDataNo(viewModel, models, ref effective)
                        .QueryByBuyerReceiptNo(viewModel, models, ref effective)
                        .QueryByBuyerName(viewModel, models, ref effective)
            ...
            if (viewModel.AgentID.HasValue)
            {
                items = models.GetAllowanceByAgent(items, viewModel.AgentID.Value);
            }

            return items;
        }

        public static IQueryable<InvoiceAllowance> QueryByBuyerName(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
            viewModel.BuyerName = viewModel.BuyerName.GetEfficientString();
            if (viewModel.BuyerName != null)
        ...
        public static IQueryable<InvoiceAllowance> QueryBySeller(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
        ...
        public static IQueryable<InvoiceAllowance> QueryByCustomerID(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
            viewModel.CustomerID = viewModel.CustomerID.GetEfficientString();
            if (viewModel.CustomerID != null)
        ...
        public static IQueryable<InvoiceAllowance> QueryByBuyerReceiptNo(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
            viewModel.BuyerReceiptNo = viewModel.BuyerReceiptNo.GetEfficientString();
            if (viewModel.BuyerReceiptNo != null)
        ...
        public static IQueryable<InvoiceAllowance> QueryByAllowanceDate(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            if (viewModel != null)
            {
                if (viewModel.DateFrom.HasValue)
        ...
        public static IQueryable<InvoiceAllowance> QueryByDataNo(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel.DataNo = viewModel.DataNo.GetEfficientString();
            viewModel.EndNo = viewModel.EndNo.GetEfficientString();
            ...
            if (viewModel.DataNo != null && viewModel.EndNo != null)
            {
                ...
                items = items.Where(i => (i.AllowanceNumber.CompareTo(viewModel.DataNo) >= 0 && i.AllowanceNumber.CompareTo(viewModel.EndNo) <= 0)
                    || i.InvoiceAllowanceDetails.Any(d => d.InvoiceNo.CompareTo(viewModel.DataNo) >= 0 && d.InvoiceNo.CompareTo(viewModel.EndNo) <= 0));
                effective = true;
            }
            else
            {
                ...
                if (dataNo != null)
                {
                    items = items.Where(i => i.AllowanceNumber == dataNo
                                || i.InvoiceAllowanceDetails.Any(d => d.InvoiceNo == dataNo));
                    effective = true;
                }
            }
        ...
        public static IQueryable<InvoiceAllowance> QueryByProcessType(this IQueryable<InvoiceAllowance> items, InquireInvoiceViewModel? viewModel, GenericDbContext<ApplicationDbContext> models, ref bool effective)
        {
            viewModel ??= new InquireInvoiceViewModel { };
            //if (viewModel.ProcessType.HasValue)
            //{
        ...
        public static IQueryable<InvoiceNoInterval> InquireInvoiceNoInterval(this InquireNoIntervalViewModel viewModel, GenericDbContext<ApplicationDbContext> models, UserProfileWrapper? profile = null)
        {
            ...
            {
                items = items.Where(i => i.InvoiceTrackCodeAssignment.Track.Year == viewModel.Year);
            }

            if (viewModel.PeriodNo.HasValue)
                items = items.Where(i => i.InvoiceTrackCodeAssignment.Track.PeriodNo == viewModel.PeriodNo);

            return items;

        }

        public static IQueryable<Organization> InitializeOrganizationQuery(this UserProfileWrapper userProfile, GenericDbContext<ApplicationDbContext> mgr)
        {
        ...
        public static IQueryable<InvoiceNoMainAssignment> InquireHeaquarterNoAssignment(this InquireNoIntervalViewModel viewModel, GenericDbContext<ApplicationDbContext> models)
        {
