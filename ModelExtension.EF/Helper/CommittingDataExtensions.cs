...
namespace ModelCore.Helper
{
    ...
    {
        public static Organization CommitOrganizationViewModel(this OrganizationViewModel viewModel, GenericDbContext<ApplicationDbContext> models, ModelStateDictionary modelState)
        {
            ...
            if (item == null)
            {
                ...
                models.GetTable<Organization>().Add(item);
            }
            ...
            extension.TaxNo = viewModel.TaxNo.GetEfficientString();
            extension.AuthorizationNotBefore = viewModel.AuthorizationNotBefore;
            extension.AuthorizationNotAfter = viewModel.AuthorizationNotAfter;
            extension.InvoiceRequestNotBefore = viewModel.InvoiceRequestNotBefore;
            extension.InvoiceRequestNotAfter = viewModel.InvoiceRequestNotAfter;
        ...
        public static Organization CommitOrganizationViewModelForBusiness(this OrganizationViewModel viewModel, GenericDbContext<ApplicationDbContext> models, ModelStateDictionary modelState)
        {
            viewModel.OrganizationValueCheck(modelState);
            ...
            if (item == null || item.ReceiptNo != viewModel.ReceiptNo)
            {
                modelState.AddModelError("ReceiptNo", "營業人統編不符!!");
            }
        ...
        public static UserProfile? CommitUserProfileViewModel(this UserProfileViewModel viewModel, GenericDbContext<ApplicationDbContext> models, ModelStateDictionary modelState, UserProfileWrapper creator)
        {
        ...
        public static void UpdatePassword(this UserProfile item, UserProfileViewModel viewModel)
        {
            ...
            {
                item.Password2 = ValidityAgent.MakePassword(viewModel.Password);
                if (viewModel.WaitForCheck == true)
                    item.UserProfileStatus!.CurrentLevel = (int)Naming.MemberStatusDefinition.Checked;
            }
            item.Expiration = DateTime.Today.AddDays(ModelExtension.Properties.AppSettings.Default.UserPasswordValidDays);
        }

        public static UserRole CommitUserRoleViewModel(this UserRoleViewModel viewModel, GenericDbContext<ApplicationDbContext> models, ModelStateDictionary modelState, UserProfileWrapper creator)
        {
            ...
            models.GetTable<UserRole>().Add(item);
            models.SubmitChanges();

            return item;
        }

        public static UserProfile CreateDefaultUser(this GenericDbContext<ApplicationDbContext> models, Organization item, OrganizationCategory orgaCate)
        {
        ...
        public static BusinessRelationship CommitBusinessRelationshipViewModel(this BusinessRelationshipViewModel viewModel, GenericDbContext<ApplicationDbContext> models, ModelStateDictionary modelState)
        {
            ...
            if (item == null)
            {
                ...
                models.GetTable<BusinessRelationship>().Add(item);
            }
