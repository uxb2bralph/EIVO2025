...
namespace ModelCore.Helper
{
    ...
    {
        public static VoidInvoiceRequest? ProcessVoidInvoiceRequest(this GenericDbContext<ApplicationDbContext> models, Naming.VoidActionMode? mode, ReviseInvoiceViewModel? viewModel, InvoiceItem item)
        {
