...
namespace ModelCore.Helper
{
    ...
    {
        public static ModelSourceInquiry<InvoiceItem> CreateInvoiceInquiry(this InquireInvoiceViewModel? viewModel, UserProfileWrapper? profile)
        {
        ...
        public static ModelSourceInquiry<InvoiceAllowance> CreateAllowanceInquiry(this InquireInvoiceViewModel? viewModel, UserProfileWrapper? profile)
        {
        ...
        public static void BuildInvoiceQuery(this ModelSource<InvoiceItem> modelSource, InquireInvoiceViewModel viewModel, UserProfileWrapper? profile, String? resultAction)
        {
            ...
            where TEntity : class, new()
        {
            ...
            {
                sqlCmd.Connection = (SqlConnection)models.GetDataContext().Database.GetDbConnection();
        ...
        public static DataSet GetDataSetResult(this GenericDbContext<ApplicationDbContext> models, IQueryable items, DataTable table)
        {
            using (SqlCommand sqlCmd = (SqlCommand)models.GetCommand(items))
            {
        ...
        public static DataSet GetDataSetResult(this GenericDbContext<ApplicationDbContext> models, SqlCommand sqlCmd, DataTable table)
        {
        ...
        public static void SaveAsExcel(this IQueryable<dynamic> items, GenericDbContext<ApplicationDbContext> models, String tableName, String resultFile)
        {
