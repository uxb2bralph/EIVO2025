...
namespace ModelCore.Helper
{
    public static class MvcValidation
    {
        public static void OrganizationValueCheck(this OrganizationViewModel viewModel, ModelStateDictionary modelState)
        {
            ...
            if (viewModel.TaxNo != null)
            {
                if(!Regex.IsMatch(viewModel.TaxNo,"\\d{9}"))
                {
        ...
        public static void UserProfileValueCheck(this UserProfileViewModel viewModel, UserProfileWrapper profile, ModelStateDictionary modelState,bool forcedPassword = true)
        {
        ...
        public static void UserRoleValueCheck(this UserRoleViewModel viewModel, UserProfileWrapper profile, ModelStateDictionary modelState)
        {
