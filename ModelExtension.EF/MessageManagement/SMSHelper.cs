...
namespace ModelCore.MessageManagement
{
    ...
    {
        private EV8DSMS.SMSSoapClient smsService;
        ...
        public bool Start()
        {
            smsService = new EV8DSMS.SMSSoapClient(EV8DSMS.SMSSoapClient.EndpointConfiguration.SMSSoap, ModelExtension.Properties.AppSettings.Default.EV8D_SMS);
            return getConnection(ModelExtension.Properties.AppSettings.Default.EV8D_ID, ModelExtension.Properties.AppSettings.Default.EV8D_PASSWORD);
        }
