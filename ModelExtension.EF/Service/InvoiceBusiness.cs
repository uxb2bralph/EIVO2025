...
namespace ModelCore.Service
{
    ...
    {
        public static void MarkPrintedLog(this GenericDbContext<ApplicationDbContext> models, InvoiceItem item, int uid)
        {
        ...
        public static void MarkPrintedLog(this GenericDbContext<ApplicationDbContext> models, InvoiceAllowance item, int uid)
        {
