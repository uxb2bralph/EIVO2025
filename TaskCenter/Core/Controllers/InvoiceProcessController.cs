...
namespace TaskCenter.Core.Controllers
{
    ...
    public class InvoiceProcessController : ApiBaseController
    {
        ...
        {
            /// TODO: Validate organization and authentication, 下述方法擇一
            /// 1. 使用 viewModel 中的資料進行驗證
            /// 2. 使用 HttpContext 中的認證資訊進行驗證
            /// 3. Header 中的 API Key 驗證, Authorization: Bearer {token}
            return null;
        }
