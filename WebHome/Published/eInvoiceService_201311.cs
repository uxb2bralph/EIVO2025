    ...
    public partial class eInvoiceService
    {
        ...
        public virtual XmlDocument UploadInvoiceV2_C0401(XmlDocument uploadData)
        {
            ...
            try
            {
                ...
                if (crypto.VerifyXmlSignature(uploadData))
                {
                    ModelCore.Schema.TurnKey.C0401.Invoice invoice = uploadData.TrimAll().ConvertTo<ModelCore.Schema.TurnKey.C0401.Invoice>();
        ...
        public virtual XmlDocument UploadAllowance_D0401(XmlDocument uploadData)
        {
            ...
            try
            {
                ...
                if (crypto.VerifyXmlSignature(uploadData))
                {
                    ModelCore.Schema.TurnKey.D0401.Allowance allowance = uploadData.TrimAll().ConvertTo<ModelCore.Schema.TurnKey.D0401.Allowance>();
        ...
        public virtual XmlDocument UploadInvoiceCancellationV2_C0501(XmlDocument uploadData)
        {
            ...
            try
            {
                ...
                if (crypto.VerifyXmlSignature(uploadData))
                {
                    ModelCore.Schema.TurnKey.C0501.CancelInvoice item = uploadData.TrimAll().ConvertTo<ModelCore.Schema.TurnKey.C0501.CancelInvoice>();
        ...
        public virtual XmlDocument UploadAllowanceCancellationV2_D0501(XmlDocument uploadData)
        {
            ...
            try
            {
                ...
                if (crypto.VerifyXmlSignature(uploadData))
                {
                    ModelCore.Schema.TurnKey.D0501.CancelAllowance item = uploadData.TrimAll().ConvertTo<ModelCore.Schema.TurnKey.D0501.CancelAllowance>();
