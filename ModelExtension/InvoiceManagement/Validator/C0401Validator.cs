...
using ModelCore.Schema.TurnKey.C0401;
...
namespace ModelCore.InvoiceManagement.Validator
{
    public partial class C0401Validator : InvoiceRootInvoiceValidator
    {
        ...
        protected override Exception checkInvoice()
        {
            _newItem = new InvoiceItem
            {
                ...
                InvoiceAmountType = new InvoiceAmountType
                {
                    ...
                    TotalAmountInChinese = ValidityAgent.MoneyShow(_c0401Item.Amount.TotalAmount),
                },
        ...
        protected override Exception checkMandatoryFields()
        {
            ...
            if (_c0401Item.Main.BuyerRemark.HasValue && !Enum.IsDefined(typeof(ModelCore.Schema.TurnKey.C0401.BuyerRemarkEnum), (int)_c0401Item.Main.BuyerRemark))
            {
            ...
            if (_c0401Item.Main.CustomsClearanceMark.HasValue && !Enum.IsDefined(typeof(ModelCore.Schema.TurnKey.C0401.CustomsClearanceMarkEnum), _c0401Item.Main.CustomsClearanceMark))
            {
