...
namespace ModelCore.InvoiceManagement.zhTW
{
    public static partial class InvoiceRootValidator_C0401
    {
        ...
        public static Exception CheckDataLength(this ModelCore.Schema.TurnKey.C0401.Invoice invItem)
        {
            #region 賣方
            ...
            if (invItem.Main.BuyerRemark.HasValue && !Enum.IsDefined(typeof(ModelCore.Schema.TurnKey.C0401.BuyerRemarkEnum), invItem.Main.BuyerRemark))
            {
            ...
            if (invItem.Main.CustomsClearanceMark.HasValue && !Enum.IsDefined(typeof(ModelCore.Schema.TurnKey.C0401.CustomsClearanceMarkEnum), invItem.Main.CustomsClearanceMark))
            {
        ...
        public static Exception CheckInvoice(this ModelCore.Schema.TurnKey.C0401.Invoice invItem, GenericManager<EIVOEntityDataContext> mgr, out String trackCode, out String invNo, out DateTime invoiceDate)
        {
            trackCode = null;
            invNo = null;
        ...
        public static Exception CheckBusiness(this ModelCore.Schema.TurnKey.C0401.Invoice invItem, GenericManager<EIVOEntityDataContext> mgr, OrganizationToken owner, out Organization seller)
        {
        ...
        public static Exception CheckAmount(this ModelCore.Schema.TurnKey.C0401.Invoice invItem)
        {
            //應稅銷售額
        ...
        public static Exception CheckInvoiceProductItems(this ModelCore.Schema.TurnKey.C0401.Invoice invItem, out IEnumerable<InvoiceProductItem> productItems)
        {
            short seqNo = 1;
