    ...
    public class InvoiceMailTrackingInspector : ServerInspector
    {
        ...
        public String GetInvoiceMailTracking()
        {
            ...
            try
            {
                ...
                String storedPath = Settings.Default.DownloadDataInAbsolutePath ? Settings.Default.DownloadInvoiceMailTracking : Path.Combine(Settings.Default.InvoiceTxnPath[0], Settings.Default.DownloadInvoiceMailTracking);
        ...
        public String GetInvoiceReturnedMail()
        {
            ...
            try
            {
                ...
                String storedPath = Settings.Default.DownloadDataInAbsolutePath ? Settings.Default.DownloadInvoiceReturnedMail : Path.Combine(Settings.Default.InvoiceTxnPath[0], Settings.Default.DownloadInvoiceReturnedMail);
                ValidityAgent.CheckAndCreatePath(storedPath);
                //storedPath = ValidityAgent.GetDateStylePath(storedPath);
                bool hasNew = false;
