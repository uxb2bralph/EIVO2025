...
namespace InvoiceClient.Agent
{
    ...
    public class VacantInvoiceNoInspector : ServerInspector
    {
        ...
        public bool ReceiveVacantInvoiceNo()
        {
            ...
            try
            {
                String storedPath = Settings.Default.DownloadDataInAbsolutePath ? Settings.Default.VacantInvoiceNoFolder : Path.Combine(Settings.Default.InvoiceTxnPath[0], Settings.Default.VacantInvoiceNoFolder);
        ...
        public override void ExecutiveService(List<string> pathInfo)
        {
            if (ReceiveVacantInvoiceNo())
                pathInfo.Add(Settings.Default.DownloadDataInAbsolutePath ? Settings.Default.VacantInvoiceNoFolder : Path.Combine(Settings.Default.InvoiceTxnPath[0], Settings.Default.VacantInvoiceNoFolder));
