...
namespace InvoiceClient.Agent
{
    ...
    public class WinningInvoiceInspector : ServerInspector
    {
        ...
        public ModelCore.Schema.EIVO.BonusInvoiceRoot GetIncomingWinningInvoices()
        {
            ...
            try
            {
                ...
                if (doc != null)
                {
                    String storedPath = Path.Combine(Settings.Default.InvoiceTxnPath[0], Settings.Default.DownloadWinningFolder);
                    ...
                    ModelCore.Schema.EIVO.BonusInvoiceRoot result = doc.ConvertTo<ModelCore.Schema.EIVO.BonusInvoiceRoot>();
        ...
        public override void ExecutiveService(List<string> pathInfo)
        {
            if (GetIncomingWinningInvoices() != null)
                pathInfo.Add(Path.Combine(Settings.Default.InvoiceTxnPath[0], Settings.Default.DownloadWinningFolder));
