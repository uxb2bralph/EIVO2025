...
{
    public class ReceivedB0202Watcher : InvoiceWatcher
    {
        public ReceivedB0202Watcher(String fullPath)
            : base(fullPath)
        {
        }
        ...
        protected override void processFile(String invFile)
        {
            ...
            try
            {
                ...
                using (B2BInvoiceManager models = new B2BInvoiceManager { ProcessType = Naming.InvoiceProcessType.B0202 })
                {
                    models.ReceiveB0202(doc);
