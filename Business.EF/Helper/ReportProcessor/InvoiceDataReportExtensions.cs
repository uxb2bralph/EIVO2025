...
namespace Business.Helper.ReportProcessor
{
    public static class InvoiceDataReportExtensions
    {
        ...
        public static IQueryable<InvoiceItem> GetInvoice(this GenericDbContext<ApplicationDbContext> models, int sellerID, DateTime dateFrom, DateTime dateTo)
        {
        ...
        public static MonthlyBilling GetSellerMonthlyBilling(
            GenericDbContext<ApplicationDbContext> dataModels
            ...
            , DateTime queryFromDate)
        {
            ...
            return dataModels.GetTable<Settlement>()
                    ...
                    .Join(dataModels.GetTable<MonthlyBilling>().Where(i => i.Company == organization),
                                    c => c.SettlementID
                                    , i => i.SettlementID
                                    , (c, i) => i).FirstOrDefault();
        }

        public static IQueryable<InvoiceCancellation> GetInvoiceCancellation(this GenericDbContext<ApplicationDbContext> models, int sellerID, DateTime dateFrom, DateTime dateTo)
        {
        ...
        public static IQueryable<InvoiceAllowance> GetAllowance(this GenericDbContext<ApplicationDbContext> models, int sellerID, DateTime dateFrom, DateTime dateTo)
        {
        ...
        public static IQueryable<InvoiceAllowanceCancellation> GetAllowanceCancellation(this GenericDbContext<ApplicationDbContext> models, int sellerID, DateTime dateFrom, DateTime dateTo)
        {
